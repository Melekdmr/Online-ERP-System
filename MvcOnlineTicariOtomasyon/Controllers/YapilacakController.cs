...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class YapilacakController : Controller
    {
        ...
        public ActionResult Index()
        {
			...
			var deger4 = c.Personels.Count().ToString();
			ViewBag.d4 = deger4;


            /* var deger4 = (from x in c.Carilers select x.CariSehir).Distinct().Count().ToString();
             ViewBag.d4 = deger4;   şehir sayısını listeledik ama ben sayfada personel sayısının görünmesinin daha uygun olacağını düşündüm*/
